...
class HistorialVacunacion2Widget extends StatefulWidget {
  const HistorialVacunacion2Widget({Key? key}) : super(key: key);
...
class _HistorialVacunacionWidgetState
    extends State<HistorialVacunacion2Widget> {
  ApiCallResponse? apiResultvacunacion;
  TextEditingController? dosisController;
  TextEditingController? vacunaController;
  TextEditingController? numeroloteController;
  TextEditingController? fechaplicacionController;
  ...
  void initState() {
    ...
    numeroloteController = TextEditingController();
    fechaplicacionController = TextEditingController();
  }
  ...
  void dispose() {
    ...
    fechaplicacionController?.dispose();
    super.dispose();
  }
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            10, 0, 0, 0),
                                        child: TextFormField(
                                          controller: fechaplicacionController,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            hintText: 'Escribe aquí',
                      ...
                      Expanded(
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final buttonVaccinationResponse = snapshot.data!;
                            return FFButtonWidget(
                              onPressed: () async {
                                var _shouldSetState = false;
                                apiResultvacunacion =
                                    await VaccinationCall.call(
                                  vaccine: vacunaController!.text,
                                  dose: dosisController!.text,
                                  lotNumber: numeroloteController!.text,
                                  applicationDate:
                                      fechaplicacionController!.text,
                                );
                                _shouldSetState = true;
                                if ((apiResultvacunacion?.succeeded ?? true)) {
